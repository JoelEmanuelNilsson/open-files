...
description: Generate a project-local skill that drives the real app the way a user does. Use when a repo has no scripted way to prove UI, CLI, or service behavior.
