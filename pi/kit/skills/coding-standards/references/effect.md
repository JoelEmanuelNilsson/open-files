...
Vendored Effect v4 source: `~/.agents/repos/effect`, with the v4 line in `packages/effect`. Read it there. It is read-only reference: never edit it, never import from it.
