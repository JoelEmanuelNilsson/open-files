...
Vendored Alchemy source: `~/.agents/repos/alchemy`, with the v2 line in `packages/alchemy`. Read it there. It is read-only reference: never edit it, never import from it.
