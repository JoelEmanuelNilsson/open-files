...
/**
 * What produced the captured snapshot: a real model turn observed passively, or
 * the degraded rebuild from pi's own prompt options when no turn has run yet.
 */
export type CaptureOrigin = "real-turn" | "pi-native";
